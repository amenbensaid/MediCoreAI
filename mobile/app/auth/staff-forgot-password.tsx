...
const copy = {
  fr: {
    ...
    subtitle: 'Entrez votre email staff. Un administrateur plateforme recevra votre demande et pourra définir un mot de passe temporaire.',
    email: 'Email',
    missingEmail: 'Entrez une adresse email valide.',
    submit: 'Envoyer la demande',
    successTitle: 'Demande envoyée',
    successText: 'Si ce compte existe, une demande de réinitialisation a été envoyée à l’administrateur.',
    backLogin: 'Retour connexion staff',
  ...
  en: {
    ...
    subtitle: 'Enter your staff email. A platform administrator will receive your request and can set a temporary password.',
    email: 'Email',
    missingEmail: 'Enter a valid email address.',
    submit: 'Send request',
    successTitle: 'Request sent',
    successText: 'If this account exists, a password reset request was sent to the administrator.',
    backLogin: 'Back to staff login',
    backHome: 'Home',
  },
};
...
export default function StaffForgotPasswordScreen() {
  ...
  const submit = async () => {
    ...
    setLoading(true);
    try {
      await authApi.staffForgotPassword(email.trim());
      setSent(true);
    } catch (nextError) {
