            ...
            <div className="w-full max-w-md">
                ...
                <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-2xl p-8">
                    <div className="text-center mb-6">
                        <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Patient Sign In</h2>
                        <p className="text-gray-500 dark:text-gray-400 mt-1">Access your appointments & records</p>
                    </div>
                    ...
                    <div className="mt-6 text-center space-y-2">
                        <p className="text-gray-500 dark:text-gray-400 text-sm">
                            ...
                            <Link to="/patient/register" className="text-primary-500 hover:text-primary-600 font-medium">Sign Up</Link>
                        </p>
